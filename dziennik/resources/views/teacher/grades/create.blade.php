        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <form method="POST" action="{{ route('teacher.grades.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.1" name="grade" id="grade" required min="1" max="6"
                           class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm" />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="comment" id="comment" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm"></textarea>
                </div>
